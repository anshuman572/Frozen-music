...
const BOT_TOKEN = "8493462186:AAHKy4UgkWkXlhq0120zRwAc-FpU8aNIvPI";
...
async function isUserAdmin(chatId, userId) {
  const url = `https://api.telegram.org/bot${BOT_TOKEN}/getChatMember?chat_id=${encodeURIComponent(1003699128970)}&user_id=${encodeURIComponent(userId)}`;
  try {
  ...
  if (updateData.callback_query) {
    ...
    if (data === "resume") {
      ...
      const buttons = {
        inline_keyboard: [
          [
            { text: "➕ Add me", url: "https://t.me/bhagagvs?startgroup=true" },
            { text: "💬 Support", url: "https://t.me/bhagagvs" }
          ],
          [
